...
# 	# BW = BANDWIDTH OF SIGNAL in MHz

# 	ELEMENTARY_PERIOD = 7/(8*BW)  # in micro second

# 	GUARD_LENGTH  = [1/4, 1/8, 1/16, 1/32] * mode(8192,2048) * ELEMENTARY_PERIOD
# 	USEFUL_LENGTH = ELEMENTARY_PERIOD * (8192,2048)
# 	SYMBOL_LENGTH = USEFUL_LENGTH + GUARD_LENGTH
